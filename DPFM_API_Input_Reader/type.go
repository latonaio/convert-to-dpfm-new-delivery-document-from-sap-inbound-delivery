...
type SDC struct {
	...
	SAPInboundDeliveryHeader SAPInboundDeliveryHeader `json:"DeliveryDocument"`
	APISchema                string                   `json:"api_schema"`
	Accepter                 []string                 `json:"accepter"`
	Deleted                  bool                     `json:"deleted"`
}

type SAPInboundDeliveryHeader struct {
	...
	SAPInboundDeliveryHeaderPartner []SAPInboundDeliveryHeaderPartner `json:"HeaderPartner"`
	SAPInboundDeliveryItem          []SAPInboundDeliveryItem          `json:"DeliveryDocumentItem"`
}

type SAPInboundDeliveryItem struct {
...
type SAPInboundDeliveryHeaderPartner struct {
	...
	Supplier                         *string                            `json:"Supplier"`
	SAPInboundDeliveryPartnerAddress []SAPInboundDeliveryPartnerAddress `json:"PartnerAddress"`
}
